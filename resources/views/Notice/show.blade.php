                            ...
                            <div class="card-body">
                                ...
                                <form action="{{route('notice.update',$notices->id)}}" method="post">
                                    ...
                                    <div class="form-group row">
                                      ...
                                      <div class="col-sm-10">
                                        <input type="text" class="form-control" id="inputEmail3" name="title" value="{{$notices->title}}">
                                      </div>
                                    </div>
                                    <div class="form-group row">
                                      <label for="inputPassword3" class="col-sm-2 col-form-label">description**</label>
                                      <div class="col-sm-10">
                                       <textarea name="textarea"  id="textarea" cols="67" rows="8" >{{$notices->description}}</textarea>
                                      </div>
                                    </div>
                                    <div class="form-group row">
                                      <div class="col-sm-10">
