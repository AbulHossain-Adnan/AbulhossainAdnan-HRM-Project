          ...
          <li class="nav-item">
              ...
              <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                  <div class="bg-white py-2 collapse-inner rounded">
                      ...
                      <a class="collapse-item" href="">Leave list</a>
          ...
          <li class="nav-item">
              ...
              <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                  ...
                  <div class="bg-white py-2 collapse-inner rounded">
                      ...
                      <a class="collapse-item" href="{{ route('user.index') }}">File management</a>
                      <a class="collapse-item" href="{{ route('department.create') }}">department</a>
          ...
          {{-- <li class="nav-item">
              ...
              <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                  <div class="bg-white py-2 collapse-inner rounded">
                      ...
                      <a class="collapse-item" href="{{ route('post.create') }}">Post create</a>
                                    ...
                                    <div class="card border-success mb-3">
                                        ...
                                        <div class="card-body">
                                            <div class="card">
                                              ...
                                              <div class="card text-center">
                                                <div class="card border-success mb-3">
                                                    <div class="card-header text-white bg-secondary">File</div>
                                                    <div class="card-body">
                                                        <table class="table">
                                                            <thead>
                                                                <tr>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card border-success mb-3">
                                        ...
                                        <div class="card-body">
                                            <div class="card">
                                                <div class="card border-success mb-3">
                                                    <div class="card-header text-white bg-secondary">Notice Borad</div>
                                                    <div class="card-body">
                                                        <table class="table">
                                                            <thead>
                                                              <tr>
                                              ...
                                              <div class="card text-center">
                                                <div class="card border-success mb-3">
                                                    <div class="card-header text-white bg-secondary">Upcomming Hol</div>
                                                    <div class="card-body">
                                                        <table class="table">
                                                            <thead>
                                                                <tr>
                                                              ...
                                                              <tbody>
                                                                <tr>
                                                                  <th class="table-primary" scope="row">email</th>
                                                                  <td class="table-primary">adnan@gmail.com</td>
